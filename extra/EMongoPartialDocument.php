 ...
 * @since    v1.3.6
 */
abstract class EMongoPartialDocument extends \YiiMongoDbSuite\EMongoDocument
{
    /**
     * Fields that have not been loaded from DB
     * @var array
     */
    protected $_loadedFields    = array();
    /**
     * Whatever the document has been partially loaded
     * @var boolean
     */
